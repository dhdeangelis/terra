...
SpatVector SpatVector::buffer(std::vector<double> d, size_t quadsegs, std::string capstyle, std::string joinstyle, double mitrelimit, bool singlesided) {
...
SpatVector SpatVector::buffer2(std::vector<double> d, size_t quadsegs) {
